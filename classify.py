...
_TITLE_RULES = [
    ("meeting-notes", ["show and tell", "show-and-tell", "retrospective", "retro ",
                       ...
                       "minutes of meeting", "mom of", "mom -", "sync up", "sync-up",
                       "weekly sync", "weekly call", "weekly status", "status call",
                       "planning call", "sync call", "review call", "integration call",
                       "call notes", "daily scrum", "grooming", "refinement", "kick off",
                       "kick-off", "kickoff", "catch up", "catch-up", " demo", "walkthrough"]),
